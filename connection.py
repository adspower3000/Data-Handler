...
class Data:
    ...
    def get_average(self, column, filter=None, value=None):
    ...
    def get_deltaT(self):
        sql_query = f"SELECT AVERAGE"" FROM data_day_suz W"
        return self.execute_query_with_params(sql_query, query_values=None)
